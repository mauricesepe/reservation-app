...
public class PersistedRoomPersistenceImpl
	...
	public List<PersistedRoom> findByUuid(
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_PERSISTEDROOM_WHERE);
			...
			if (orderByComparator != null) {
				...
				query.append(PersistedRoomModelImpl.ORDER_BY_JPQL);
			}
	...
	public PersistedRoom findByUuid_First(
		...
		throw new NoSuchPersistedRoomException(msg.toString());
	}
	...
	protected PersistedRoom getByUuid_PrevAndNext(
		...
		List<PersistedRoom> list = q.list();
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_PERSISTEDROOM_WHERE);
	...
	public PersistedRoom remove(Serializable primaryKey)
		...
		catch (NoSuchPersistedRoomException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	public List<PersistedRoom> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_PERSISTEDROOM);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_PERSISTEDROOM);
