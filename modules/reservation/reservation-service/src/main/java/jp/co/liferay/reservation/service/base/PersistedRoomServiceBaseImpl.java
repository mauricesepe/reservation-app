...
/**
 * Provides the base implementation for the persisted room remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link jp.co.liferay.reservation.service.impl.PersistedRoomServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see jp.co.liferay.reservation.service.impl.PersistedRoomServiceImpl
 * @generated
 */
public abstract class PersistedRoomServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PersistedRoomService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>jp.co.liferay.reservation.service.PersistedRoomServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PersistedRoomService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		persistedRoomService = (PersistedRoomService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PersistedRoomService.class.getName();
	}
	...
	@Reference
	protected jp.co.liferay.reservation.service.PersistedRoomLocalService
		persistedRoomLocalService;

	protected PersistedRoomService persistedRoomService;
