...
/**
 * Provides the base implementation for the persisted purpose remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link jp.co.liferay.reservation.service.impl.PersistedPurposeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see jp.co.liferay.reservation.service.impl.PersistedPurposeServiceImpl
 * @generated
 */
public abstract class PersistedPurposeServiceBaseImpl
	extends BaseServiceImpl
	implements PersistedPurposeService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PersistedPurposeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>jp.co.liferay.reservation.service.PersistedPurposeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PersistedPurposeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		persistedPurposeService = (PersistedPurposeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PersistedPurposeService.class.getName();
	}
	...
	@Reference
	protected jp.co.liferay.reservation.service.PersistedPurposeLocalService
		persistedPurposeLocalService;

	protected PersistedPurposeService persistedPurposeService;
