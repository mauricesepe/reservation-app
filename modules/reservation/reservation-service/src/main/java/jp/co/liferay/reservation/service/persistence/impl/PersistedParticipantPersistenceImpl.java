...
public class PersistedParticipantPersistenceImpl
	...
	public List<PersistedParticipant> findByUuid(
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_PERSISTEDPARTICIPANT_WHERE);
			...
			if (orderByComparator != null) {
				...
				query.append(PersistedParticipantModelImpl.ORDER_BY_JPQL);
			}
	...
	public PersistedParticipant findByUuid_First(
		...
		throw new NoSuchPersistedParticipantException(msg.toString());
	}
	...
	protected PersistedParticipant getByUuid_PrevAndNext(
		...
		List<PersistedParticipant> list = q.list();
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_PERSISTEDPARTICIPANT_WHERE);
	...
	public PersistedParticipant remove(Serializable primaryKey)
		...
		catch (NoSuchPersistedParticipantException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	public List<PersistedParticipant> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_PERSISTEDPARTICIPANT);
				...
				if (pagination) {
					sql = sql.concat(
						PersistedParticipantModelImpl.ORDER_BY_JPQL);
				}
			}
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_PERSISTEDPARTICIPANT);
