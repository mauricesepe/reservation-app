...
public class PersistedBookingPersistenceImpl
	...
	public List<PersistedBooking> findByUuid(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_PERSISTEDBOOKING_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(PersistedBookingModelImpl.ORDER_BY_JPQL);
			}
	...
	public PersistedBooking findByUuid_First(
		...
		throw new NoSuchPersistedBookingException(sb.toString());
	}
	...
	protected PersistedBooking getByUuid_PrevAndNext(
		...
		List<PersistedBooking> list = query.list();
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_PERSISTEDBOOKING_WHERE);
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, PersistedBookingImpl.class, primaryKey);
		}
	}
	...
	public PersistedBooking remove(Serializable primaryKey)
		...
		catch (NoSuchPersistedBookingException noSuchEntityException) {
	...
	public List<PersistedBooking> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_PERSISTEDBOOKING);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_PERSISTEDBOOKING);
