...
/**
 * Provides the base implementation for the persisted booking remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link jp.co.liferay.reservation.service.impl.PersistedBookingServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see jp.co.liferay.reservation.service.impl.PersistedBookingServiceImpl
 * @generated
 */
public abstract class PersistedBookingServiceBaseImpl
	extends BaseServiceImpl
	implements PersistedBookingService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PersistedBookingService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>jp.co.liferay.reservation.service.PersistedBookingServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PersistedBookingService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		persistedBookingService = (PersistedBookingService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PersistedBookingService.class.getName();
	}
	...
	@Reference
	protected jp.co.liferay.reservation.service.PersistedBookingLocalService
		persistedBookingLocalService;

	protected PersistedBookingService persistedBookingService;
