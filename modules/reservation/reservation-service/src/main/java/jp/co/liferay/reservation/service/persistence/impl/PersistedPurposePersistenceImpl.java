...
public class PersistedPurposePersistenceImpl
	...
	public List<PersistedPurpose> findByUuid(
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_PERSISTEDPURPOSE_WHERE);
			...
			if (orderByComparator != null) {
				...
				query.append(PersistedPurposeModelImpl.ORDER_BY_JPQL);
			}
	...
	public PersistedPurpose findByUuid_First(
		...
		throw new NoSuchPersistedPurposeException(msg.toString());
	}
	...
	protected PersistedPurpose getByUuid_PrevAndNext(
		...
		List<PersistedPurpose> list = q.list();
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_PERSISTEDPURPOSE_WHERE);
	...
	public PersistedPurpose remove(Serializable primaryKey)
		...
		catch (NoSuchPersistedPurposeException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	public List<PersistedPurpose> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_PERSISTEDPURPOSE);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_PERSISTEDPURPOSE);
