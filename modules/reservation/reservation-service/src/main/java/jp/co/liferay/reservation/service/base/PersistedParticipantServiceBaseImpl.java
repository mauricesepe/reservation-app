...
/**
 * Provides the base implementation for the persisted participant remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link jp.co.liferay.reservation.service.impl.PersistedParticipantServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see jp.co.liferay.reservation.service.impl.PersistedParticipantServiceImpl
 * @generated
 */
public abstract class PersistedParticipantServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PersistedParticipantService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>jp.co.liferay.reservation.service.PersistedParticipantServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PersistedParticipantService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		persistedParticipantService = (PersistedParticipantService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PersistedParticipantService.class.getName();
	}
	...
	@Reference
	protected jp.co.liferay.reservation.service.PersistedParticipantLocalService
		persistedParticipantLocalService;

	protected PersistedParticipantService persistedParticipantService;
