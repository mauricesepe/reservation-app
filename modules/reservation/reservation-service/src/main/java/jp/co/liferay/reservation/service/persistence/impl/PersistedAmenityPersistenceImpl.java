...
public class PersistedAmenityPersistenceImpl
	...
	public List<PersistedAmenity> findByUuid(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_PERSISTEDAMENITY_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(PersistedAmenityModelImpl.ORDER_BY_JPQL);
			}
	...
	public PersistedAmenity findByUuid_First(
		...
		throw new NoSuchPersistedAmenityException(sb.toString());
	}
	...
	protected PersistedAmenity getByUuid_PrevAndNext(
		...
		List<PersistedAmenity> list = query.list();
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_PERSISTEDAMENITY_WHERE);
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, PersistedAmenityImpl.class, primaryKey);
		}
	}
	...
	public PersistedAmenity remove(Serializable primaryKey)
		...
		catch (NoSuchPersistedAmenityException noSuchEntityException) {
	...
	public List<PersistedAmenity> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_PERSISTEDAMENITY);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_PERSISTEDAMENITY);
