...
public interface OfficeResource {
	...
	public void deleteOffice(String officeId) throws Exception;

	public Office getOffice(String officeId) throws Exception;

	public Office putOffice(String officeId, Office office) throws Exception;
