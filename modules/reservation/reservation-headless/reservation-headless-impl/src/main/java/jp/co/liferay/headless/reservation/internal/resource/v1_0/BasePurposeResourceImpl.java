...
@Generated("")
@Path("/v1.0")
public abstract class BasePurposeResourceImpl
	implements PurposeResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<Purpose> {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/reservation-headless/v1.0/purposes'  -u 'test@liferay.com:test'
	 */
	@Override
	@GET
	@Operation(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/reservation-headless/v1.0/purposes' -d $'{"name": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/reservation-headless/v1.0/purposes/{purposeId}'  -u 'test@liferay.com:test'
	 */
	@Override
	@DELETE
	@Operation(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/reservation-headless/v1.0/purposes/{purposeId}'  -u 'test@liferay.com:test'
	 */
	@Override
	@GET
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/reservation-headless/v1.0/purposes/{purposeId}' -d $'{"name": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@Override
	@Consumes({"application/json", "application/xml"})
	...
	public void create(
			java.util.Collection<Purpose> purposes,
	...
	@Override
	public Page<Purpose> read(
			Filter filter, Pagination pagination, Sort[] sorts,
			Map<String, Serializable> parameters, String search)
		throws Exception {

		return getPurposesPage(search, filter, pagination, sorts);
	}
