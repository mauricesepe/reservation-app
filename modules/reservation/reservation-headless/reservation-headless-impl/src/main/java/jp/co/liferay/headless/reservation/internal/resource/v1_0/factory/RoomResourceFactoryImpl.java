 ...
 * @generated
 */
@Component(immediate = true, service = RoomResource.Factory.class)
@Generated("")
public class RoomResourceFactoryImpl implements RoomResource.Factory {
	...
	public RoomResource.Builder create() {
		return new RoomResource.Builder() {
			...
			public RoomResource build() {
				...
				return (RoomResource)ProxyUtil.newProxyInstance(
					RoomResource.class.getClassLoader(),
	...
	protected void activate() {
		RoomResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		RoomResource.FactoryHolder.factory = null;
	}
