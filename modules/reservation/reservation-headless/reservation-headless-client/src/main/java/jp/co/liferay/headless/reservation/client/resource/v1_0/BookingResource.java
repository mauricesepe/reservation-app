...
public interface BookingResource {
	...
	public HttpInvoker.HttpResponse getBookingsPageHttpResponse(
			String search, String filterString, Pagination pagination,
			String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postBookingHttpResponse(Booking booking)
		throws Exception;

	public void postBookingBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postBookingBatchHttpResponse(
			String callbackURL, Object object)
		throws Exception;

	public void deleteBooking(String bookingId) throws Exception;

	public HttpInvoker.HttpResponse deleteBookingHttpResponse(String bookingId)
		throws Exception;

	public void deleteBookingBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse deleteBookingBatchHttpResponse(
			String callbackURL, Object object)
		throws Exception;

	public Booking getBooking(String bookingId) throws Exception;

	public HttpInvoker.HttpResponse getBookingHttpResponse(String bookingId)
		throws Exception;

	public Booking putBooking(String bookingId, Booking booking)
		throws Exception;

	public HttpInvoker.HttpResponse putBookingHttpResponse(
			String bookingId, Booking booking)
		throws Exception;

	public void putBookingBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse putBookingBatchHttpResponse(
			String callbackURL, Object object)
		throws Exception;
	...
	public static class Builder {
		...
		public BookingResource build() {
			return new BookingResourceImpl(this);
		}
	...
	public static class BookingResourceImpl implements BookingResource {
		...
		public HttpInvoker.HttpResponse getBookingsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/reservation-headless/v1.0/bookings");
		...
		public void postBookingBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse =
				postBookingBatchHttpResponse(callbackURL, object);
		...
		public HttpInvoker.HttpResponse postBookingBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/reservation-headless/v1.0/bookings/batch");
		...
		public HttpInvoker.HttpResponse deleteBookingHttpResponse(
				String bookingId)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/reservation-headless/v1.0/bookings/{bookingId}",
				bookingId);
		...
		public void deleteBookingBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteBookingBatchHttpResponse(callbackURL, object);
		...
		public void putBookingBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse = putBookingBatchHttpResponse(
				callbackURL, object);
		...
		private BookingResourceImpl(Builder builder) {
			_builder = builder;
		}
